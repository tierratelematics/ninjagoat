/// <reference path="typings/browser/ambient/inversify/index.d.ts" />
/// <reference path="typings/browser/ambient/rx/index.d.ts" />
/// <reference path="typings/browser/ambient/react/index.d.ts" />

declare module '~ninjagoat/ninjagoat' {
...
declare module 'ninjagoat' {
    import main = require('~ninjagoat/ninjagoat');
    export = main;
}